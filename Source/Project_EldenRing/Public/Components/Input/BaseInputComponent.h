 ...
 */
UCLASS()
class PROJECT_ELDENRING_API UBaseInputComponent : public UEnhancedInputComponent
{
	GENERATED_BODY()
...
template <class UserObject, typename CallbackFunc>
void UBaseInputComponent::BindAbilityInputAction(const UDataAsset_InputConfig* InInputConfig, UserObject* ContextObject,
	CallbackFunc InputPressedFunc, CallbackFunc InputRelesedFunc)
{
	checkf(InInputConfig, TEXT("Input config data asset is null,can not proceed with binding"));
